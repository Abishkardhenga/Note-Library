...
import { sendOTP, generateOTP, encryptOTP } from '../lib/emailService';
...
interface AuthContextType {
  ...
  signUpWithEmail: (email: string, password: string, name: string, grade: string) => Promise<void>;
  logout: () => Promise<void>;
}

const AuthContext = createContext<AuthContextType | undefined>(undefined);

const createUserProfile = async (firebaseUser: FirebaseUser, grade?: string): Promise<User> => {
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const signUpWithEmail = async (email: string, password: string, name: string, grade: string) => {
    try {
